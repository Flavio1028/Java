...
public class AgendamentoController {
	...
	public ResponseEntity<?> getHorarios(@PathVariable("id") Long id,
		...
		return ResponseEntity.ok(this.service.buscarHorariosNaoAgendadosPorMedicoIdEData(id, data));
	}
	...
	public String preEditarConsultaPaciente(@PathVariable("id") Long id, ModelMap model,
		...
		Agendamento agendamento = this.service.buscarPorIdEUsuario(id, user.getUsername());
